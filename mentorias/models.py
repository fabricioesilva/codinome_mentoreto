...
class PoliticaAceitaPorAluno(models.Model):
    ...
    politica_aceita = models.ForeignKey(PolicyRules, verbose_name=_(
    ...
    def __str__(self):        
        return f'{self.login_aluno}, {self.acept_date}, {self.politica_aceita}'
